<div id="author" itemprop="author" itemref="authorImage" itemscope itemtype="http://schema.org/Person"><h2>About <span itemprop="name">John Cusack</span></h2></div>
<div id="authorImage" itemscope itemtype='http://schema.org/ImageObject' class="john_image" >
    <img itemprop="thumbnail" src="/images/people/john_cusack.png">
</div>
