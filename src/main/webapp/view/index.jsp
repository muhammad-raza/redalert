...
<div id="container" data-role="page">    
    ...
    <div class="upper_body">
        ...
        <div itemscope itemtype="http://schema.org/Book" itemref="edition description rating review" class="main_heading_desc"><span itemprop="name">Money Laundering Cases and Materials</span></br> by <a itemscope itemtype="http://schema.org/Person" itemprop="author" itemprop="author" class="author" href="/biography">John Cusack</a></div>
        <div class="line"></div>
        <div class="line"></div>
    </div>
